      ...
      <div className=' dark '>
         <main className=' h-full w-full font-quattro '>
            ...
            <article className=' max-w-[75ch] m-auto pt-12 pb-28 px-5'>
               ...
               <p>
                  I&apos;m a software developer. I&apos;m currently working
                  as a fullstack developer at Cotiviti Pvt Ltd, Hattisar.{' '}
               </p>
               ...
               <div>
                  ...
                  <li
                     ...
                     <section>
                        ...
                        <div className='flex justify-between text-sm'>
                           <a
                              href='https://www.cotiviti.com.np/'
                              target={'_blank'}
                              rel='noreferrer'
                              className=' hover:text-[rgb(234,179,8)]'>
                  ...
                  <li
                     ...
                     <section>
                        ...
                        <p className='mt-4 mb-4 text-sm' id='projects'>
                           Developed a Synchron app where users fill up
                           daily standups of their meeting using
                           Django,Postgres &amp; next.js.
                        </p>
                     </section>
                  </li>
               </div>
                  ...
                  <li
                     ...
                     <section>
                        ...
                        <p className='mt-4 mb-4 text-sm'>
                           Final year project on classifying image into 7
                           different type of skin cancers.{' '}
                        </p>
                     </section>
                  </li>
                  <li
                     ...
                     <section>
                        <div className='flex justify-between text-sm gap-3'>
                           <h3 className=' text-left font-medium'>
                              Comparative study of Algorithms used in
                              Sentiment Analysis
                           </h3>
                           <div className='flex gap-3 text-sm'>
                              <a
                        ...
                        <p className='mt-4 mb-4 text-sm'>
                           We compared 7 different algorithms that can be
                           used for sentiment analysis. And determined best
                           algorithm for binary sentiment classification.{' '}
                        </p>
                     </section>
                  </li>
                  <li
                     ...
                     <section>
                        ...
                        <p className='mt-4 mb-4 text-sm'>
                           If you ever played marriage card game, you know
                           it&apos;s hard and time consuming to calculate
                           and keep track of points of each and every
                           player especially if you are amateure like me
                           &#128517;. So i created this app to easily keep
                           track of points of every round.
                        </p>
                     </section>
                  </li>
                  <li
                     ...
                     <section>
                        ...
                        <p className='mt-4 mb-4 text-sm'>
                           Ecommerce app to buy dairy products.
                        </p>
                     </section>
                  </li>
                  <li
                     ...
                     <section>
                        ...
                        <div className=' text-sm flex gap-2 mt-1'>
                           <Image
                              src={'/icons/C_Programming_Language.svg'}
                              alt='react'
                              height='14px'
                              width={14}
                           />
                        ...
                        <p className='mt-4 mb-4 text-sm' id='education'>
                           Built a Gregorian calendar from scratch using C.
                           It also has feature of adding memo
                        </p>
                     </section>
                  </li>
                  <li
                     ...
                     <section>
                        ...
                        <p className='mt-4 mb-4 text-sm' id='education'>
                           This Webpage you are looking at. Plus you can
                           visit subdomains.
                           <br />
                           <a
                              target={'_blank'}
               ...
               <div>
                  ...
                  <div className='flex gap-3 text-sm  items-center my-8'>
                     ...
                     <div className='link-btn'>
                        {' '}
                        Bachelors of Computer Engineering, Khwopa
                  ...
                  <div className='flex gap-3 text-sm  items-center my-8'>
                     ...
                     <div className='link-btn'>
                        {' '}
                        15 hours training on Python, Khwopa Engineering
                        College{' '}
                     </div>
                  </div>
                  ...
                  <div className='flex gap-3 text-sm  items-center my-8'>
                     ...
                     <div className='link-btn'>
                        {' '}
                        30 hours training on JAVA, Khwopa Engineering
                        College{' '}
                     </div>
                  </div>
                  ...
                  <div className='flex gap-3 text-sm  items-center my-8'>
                     ...
                     <div className='link-btn'>
                        {' '}
                        +2 Science, Khwopa Higher Secondary School |
                        Dekocha, Bhaktapur{' '}
                     </div>
                  </div>
                  ...
                  <div className='flex gap-3 text-sm  items-center my-8'>
                     ...
                     <div className='link-btn'>
                        {' '}
                        SLC, Mount Valley English School | Kwathando,
                        Bhaktapur{' '}
                     </div>
                  </div>
               </div>
